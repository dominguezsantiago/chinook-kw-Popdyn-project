...
```{r data sets}
length_ref_val <- read_xlsx(here("R","data","GAM_reference_values_v2.xlsx"))
head(length_ref_val)

gam_predictions  <- read_xlsx(here("R","data","GAM_predictions_v2.xlsx"))
...
```
To fill the NAs, *I tackled this issue based on two conditions:* 
